...
Once you followed the [USB Direct Connection](!Basic_Setup/Usb_Direct_Connection) guide and installed all the necessary drivers you can connect to the UDOO Neo Web Control Panel through one of these ways:
