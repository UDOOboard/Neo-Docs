...
<span class="label label-warning">Heads up!</span>  Disable the M4 core to give A9 control over the inner row (refer to [this guide](https://www.udoo.org/docs-neo/Cookbook_Linux/Turn_off_M4_Arduino_core.html) on how to do that).
...
To change this configuration, please follow this [guide](!Cookbook_Linux/Device_Tree_Editor).
