...
|--------|-------------------------|--------------------------------------------------------------------|
| UART_1 | Cortex A9 serial debug  | On this serial it's possible [to have access to a Linux console](!Arduino_M4_Processor/Pinout)     |
...
<a href="../img/gionji/DOCS_uart_serial.PNG" target="_blank"><img style="width:400px;" src="../img/gionji/DOCS_uart_serial.PNG"></a>
...
### UART 6
This UART is user available, but it must be included in the [device tree](!Cookbook_Linux/Device_Tree_Editor) before the use. By default all of its pins are given to A9 in GPIO mode.
