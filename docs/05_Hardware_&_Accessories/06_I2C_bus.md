...
### I2C 2
Channel 2 is by default assigned to A9. It's possible to change this assignment following this [guide](http://www.udoo.org/docs-neo/Pinmuxing/Device_Tree_Editor.html).
