        ...
        <div class="container-fluid fluid-height wrapper">
            <div class="navbar navbar-fixed-top hidden-print">
                <div class="container-fluid">
                    <a class="brand navbar-brand pull-left" href="/"><img src="http://udoo.org/docs-neo/templates/default/themes/udoo/img/logo_docs_neo.png" alt="" />   <?php echo $project_title; ?></a>
