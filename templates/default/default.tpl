...
<body>
    ...
    <!-- Homepage -->
        <div class="navbar navbar-fixed-top hidden-print">
            <div class="container">
                <a class="brand navbar-brand pull-left" href="<?php echo $index; ?>"><img src="http://udoo.org/docs-neo/templates/default/themes/udoo/img/logo_docs_neo.png" alt="" /><?php echo $project_title; ?></a>
        ...
        <div class="container-fluid fluid-height wrapper">
            <div class="navbar navbar-fixed-top hidden-print">
                <div class="container-fluid">
                    <a class="brand navbar-brand pull-left" href="http://udoo.org"><img src="http://udoo.org/docs-neo/templates/default/themes/udoo/img/logo_docs_neo.png" alt="" />   <?php echo $project_title; ?></a>
                   <div class="wrapper_shop"><a class="btn ksbutton_shop_buy btn-lg" href="http://www.udoo.org/docs/" role="button" style="margin-left: 0px;" target="_blank">GO TO UDOO QUAD\DUAL DOCS</a> <p class="navbar-text pull-right"> Generated by <a href="http://daux.io">Daux.io</a></p></div>
